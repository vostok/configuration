...
{
    [PublicAPI]
    public class LessOrEqualConstraint<T, TField> : Constraint<T>
        where TField : IComparable<TField>
    {
        public LessOrEqualConstraint(Expression<Func<T, TField>> leftSelector, Expression<Func<T, TField>> rightSelector)
        ...
        {
            return $"Value of field '{leftSelector}' is not less or equal compared to value of field '{rightSelector}'.";
        }
    }
}